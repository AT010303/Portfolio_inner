...
type GraphicsDocumentDataSlicesSlice = ImageBlockSlice | TextBlockSlice;
...
export interface ContentIndexSliceDefaultPrimary {
  /**
   * Headinng field in *ContentIndex → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.primary.headinng
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  headinng: prismic.KeyTextField;
...
export interface ExperienceSliceDefaultItem {
  ...
  /**
   * Institutuion field in *Experience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.items[].institutuion
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institutuion: prismic.KeyTextField;
